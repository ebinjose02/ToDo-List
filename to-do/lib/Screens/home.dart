...
class _HomeState extends State<Home> {
            ...
            child: Row(children: [
              Expanded(child: Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white,
                  boxShadow:const [BoxShadow(color: Colors.grey,offset: Offset(0,0),blurRadius: 10,spreadRadius: 0)
                ],
  ...
  void additem(String toDo){
    setState(() {
      todos.add(todo(id: DateTime.now().microsecondsSinceEpoch.toString(), text: toDo));
    });
...
void filter(String keyword) {
    ...
    if(keyword.isEmpty)
      ...
      searched = todos.where((item) => item.text!.toLowerCase().contains(keyword.toLowerCase())).toList();
    }
     setState(() {
       found=searched;
     });
